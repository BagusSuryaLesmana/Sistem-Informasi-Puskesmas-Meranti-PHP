        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Tanggal pasien</h3>
                </div>
                <div class="panel-body">
                    <!--membuat form untuk tambah data-->
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="no_perkara" class="col-sm-3 control-label">Kode</label>
                            <div class="col-sm-9">
						...
						<div class="form-group">
                            <label for="peminjam" class="col-sm-3 control-label">Nama Pasien</label>
                            <div class="col-sm-9">
						...
						<div class="form-group">
                            <label for="tglPinjam" class="col-sm-3 control-label">Tanggal Masuk</label>
                            <div class="col-sm-9">
