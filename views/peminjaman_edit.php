        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Update Data Penyakit</h3>
                </div>
                <div class="panel-body">
                    <!--membuat form untuk tambah data-->
                    <form class="form-horizontal" action="" method="post">
                        <div class="form-group">
                            <label for="nope" class="col-sm-3 control-label">Kode</label>
                             <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <label for="peminjam" class="col-sm-3 control-label">Nama Penyakit</label>
                            <div class="col-sm-9">
